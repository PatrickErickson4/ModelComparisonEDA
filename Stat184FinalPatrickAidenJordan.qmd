...
# Aiden, include 1 table of means, SD, quantiles, of all of our variables of interest. Look at the NaiveModel code for examples.

### Initial Exploratory Data Analysis

In order to build up on the notion of prediction, We are particularly interested in the metric of wins and losses, as this is generally the metric of greatest interest for every basketball team, every season. Therefore, our data focus will be around **wins and losses**, and the potential relationships every variable has on this metric. We can view a simple bar graph to see if there is an imbalance between wins and losses.
...
We can therefore infer that our model does improve our odds of predicting the binary classifier. **Keep in mind that this is not a measure of accuracy, rather it is a tool to be able to compare the efficacy some models with others.**
...
# Jordan or Aiden, we need to include these as footnotes. Ctrl +f the document to find where I used these, and set up footnotes and bibliography.

need to write bibliography. Here are our following sources, already cited correct.

-   Tak, Hyungsuk. "Professor of the Eberly College of Science, Pennsylvania State University."

-   H2O.ai. "Deep Learning — H2O 3.42.0.1 Documentation." H2O.ai, <https://docs.h2o.ai/h2o/latest-stable/h2o-docs/data-science/deep-learning.html>. Accessed 15 Dec. 2024.

-   "ggplot2 Package Reference." Tidyverse, <https://ggplot2.tidyverse.org/reference/>. Accessed 15 Dec. 2024.

-   Jordan, Jeremy. "A Guide to Hyperparameter Tuning." Jeremy Jordan's Blog, <https://www.jeremyjordan.me/hyperparameter-tuning/>. Accessed 15 Dec. 2024.

-   Duncan, Nate. "2011 Current NCAA Basketball Games Dataset." Kaggle, <https://www.kaggle.com/datasets/nateduncan/2011current-ncaa-basketball-games>. Accessed 15 Dec. 2024.

-   Tufte, Edward R. *The Visual Display of Quantitative Information.* 2nd ed., Graphics Press, 2001.

-   Kosslyn, Stephen Michael. *Graph Design for the Eye and Mind.* Oxford University Press, 2006.
